...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| [APS SDK 3.x (3.x branch)](https://github.com/OpenPj/alfresco-process-services-project-sdk/tree/3.x)  | 24.3.0, 24.2.1, 24.2, 24.1 | [Download APS SDK v3.0.3](https://github.com/OpenPj/alfresco-process-services-project-sdk/releases/tag/v3.0.3) | Recreate the APS SDK project from scratch and import your extensions from APS SDK 2.x (or 1.x) | Native support |
