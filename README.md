...
| [APS SDK 1.x (master branch)](https://github.com/OpenPj/alfresco-process-services-project-sdk)  | 1.11.4, 1.11.0, 1.10.0, 1.9.0.5 | [Download APS SDK v1.7.4](https://github.com/OpenPj/alfresco-process-services-project-sdk/releases/tag/v1.7.4) |
